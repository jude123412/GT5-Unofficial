...
public class LoaderGTOreDictionary implements Runnable {
    ...
    public void run() {
        ...
        GTOreDictUnificator.set(OrePrefixes.gem, Materials.Uranium, GTModHandler.getIC2Item("Uran238", 1L));
        GTOreDictUnificator.set(OrePrefixes.gem, Materials.Uranium235, GTModHandler.getIC2Item("Uran235", 1L));
        GTOreDictUnificator.set(OrePrefixes.gem, Materials.Plutonium, GTModHandler.getIC2Item("Plutonium", 1L));
