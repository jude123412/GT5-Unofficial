...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void registerMultiblockControllers() {
        ...
        ItemList.EndergenicEngine.set(
            new MTEEndergenicEngine(EndergenicEngine.ID, "multimachine.endergenic_engine", "Endergenic Engine")
                .getStackForm(1));
        addItemTooltip(ItemList.EndergenicEngine.get(1), chain(() -> "Author: ", GTAuthors.AuthorJude));
