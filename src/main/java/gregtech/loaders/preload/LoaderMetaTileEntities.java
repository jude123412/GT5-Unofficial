...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void registerMultiblockControllers() {
        ...
        ItemList.Machine_Multi_Endergenic_Engine.set(
            new MTEEndergenicEngine(ENDERGENIC_ENGINE.ID, "multimachine.endergenic_engine", "Endergenic Engine")
                .getStackForm(1));
        addItemTooltip(ItemList.Machine_Multi_Endergenic_Engine.get(1), chain(() -> "Author: ", GTValues.AuthorJude));
    }
