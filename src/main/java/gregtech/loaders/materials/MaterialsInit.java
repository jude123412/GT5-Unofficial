...
public class MaterialsInit {
    ...
    private static Materials loadIridium() {
        return new MaterialBuilder().setName("Iridium")
            ...
            .setIconSet(TextureSet.SET_DULL.withCustomTextures("iridium", MaterialIconRegistry.IconType.GEM))
            .setColor(Dyes.dyeWhite)
            .setARGB(0x00f0f0f5)
    ...
    private static Materials loadPlutonium() {
        return new MaterialBuilder().setName("Plutonium")
            ...
            .setIconSet(TextureSet.SET_METALLIC.withCustomTextures("plutonium239", MaterialIconRegistry.IconType.GEM))
            .setColor(Dyes.dyeLime)
            .setARGB(0x00f03232)
            .setTool(512, 3, 6.0f)
    ...
    private static Materials loadUranium() {
        return new MaterialBuilder().setName("Uranium")
            ...
            .setIconSet(TextureSet.SET_METALLIC.withCustomTextures("uranium238", MaterialIconRegistry.IconType.GEM))
            .setColor(Dyes.dyeGreen)
            .setARGB(0x0032f032)
            .setTool(512, 3, 6.0f)
            .addDustItems()
    ...
    private static Materials loadUranium235() {
        return new MaterialBuilder().setName("Uranium235")
            ...
            .setIconSet(TextureSet.SET_SHINY.withCustomTextures("uranium235", MaterialIconRegistry.IconType.GEM))
            .setColor(Dyes.dyeGreen)
            .setARGB(0x0046fa46)
            .setTool(512, 3, 6.0f)
