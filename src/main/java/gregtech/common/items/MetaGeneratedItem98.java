...
public class MetaGeneratedItem98 extends MetaGeneratedItem {

    public static MetaGeneratedItem98 INSTANCE;
    ...
    public enum FluidCell {
        ...
        public ItemStack get(int aStackSize) {
            trySetStack();
            return GTUtility.copyAmount(aStackSize, mStack);
        }

        private void trySetStack() {
            if (mStack == null) {
                mStack = new ItemStack(MetaGeneratedItem98.INSTANCE, 1, mId);
            }
        }
    }
