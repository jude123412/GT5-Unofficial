    ...
    public MTEEnergyPylon(int aID, String aName, String aNameRegional, int aTier) {
        super(
            ...
            new String[] {
                ...
                " ",
                "Has an internal buffer based on this formula,",
                "(Voltage * Amperage) * 200.",
                " ",
                "DE Cores & Field Generators are installed within the device!",
                "Voltage is determined by field generator tier.",
                "Amperage is determined by core tier and stack size.",
